...
part 'gmap_restaurant_bloc.freezed.dart';
part 'gmap_restaurant_event.dart';
part 'gmap_restaurant_state.dart';

class GmapRestaurantBloc extends Bloc<GmapRestaurantEvent, GmapRestaurantState> {
